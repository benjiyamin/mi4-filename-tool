// ═══════ DATA ═══════
const CONVENTIONS=[
{id:"kmz",desc:"KMZ",exampleDoc:"DocumentName",ext:"kmz",info:"Google Earth project mapping files \u2014 exported KMZ overlays, alignments, and project boundaries.",exampleName:"P3_201210-9_ProjectLimits_2025-01-15.kmz",title:true,designId:false,fpidFull:false,projectId:true,fpidShort:true,componentId:false,submittalSuffix:false,customId:false,formattedDate:true},
{id:"fdot-prod",desc:"FDOT Production Deliverables",exampleDoc:"PLANS-XX-SUBDISCIPLINE",ext:"pdf",info:"Final plan sheet deliverables submitted to FDOT \u2014 one file per discipline, no phase suffix.",exampleName:"20121095201-PLANS-01-ROADWAY.pdf",title:false,designId:false,fpidFull:true,projectId:false,fpidShort:false,componentId:true,submittalSuffix:false,customId:false,formattedDate:false},
{id:"fdot-prod-ph",desc:"FDOT Production Deliverables (Phased)",exampleDoc:"PLANS-XX-SUBDISCIPLINE",ext:"pdf",info:"Same as Production Deliverables but for phased submittals \u2014 includes a submittal phase suffix.",exampleName:"20121095201-PLANS-01-ROADWAY-90pct.pdf",title:false,designId:false,fpidFull:true,projectId:false,fpidShort:false,componentId:true,submittalSuffix:true,customId:false,formattedDate:false},
{id:"guide",desc:"Guide Sign Worksheets",exampleDoc:"GuideSignWorksheets",ext:"pdf",info:"Guide sign design worksheets submitted with the full 11-digit FPID identifier.",exampleName:"20121095201_GuideSignWorksheets.pdf",title:true,designId:false,fpidFull:true,projectId:false,fpidShort:false,componentId:false,submittalSuffix:false,customId:false,formattedDate:false},
{id:"design",desc:"Design Submittal",exampleDoc:"DocumentName",ext:"pdf",info:"Design documents tracked by project, phase, and submittal number \u2014 reports, calculations, memos, and analysis packages.",exampleName:"P3-PS-0001.00_PvmtDsgnRpt.pdf",title:true,designId:true,fpidFull:false,projectId:false,fpidShort:false,componentId:false,submittalSuffix:false,customId:false,formattedDate:false},
{id:"fpid-doc",desc:"FPID Document",exampleDoc:"DocumentName",ext:"pdf",info:"General project documents identified by short FPID \u2014 correspondence, approvals, and miscellaneous deliverables.",exampleName:"201210-9_TypSectionPkg.pdf",title:true,designId:false,fpidFull:false,projectId:false,fpidShort:true,componentId:false,submittalSuffix:false,customId:false,formattedDate:false},
{id:"permit",desc:"Permit Document",exampleDoc:"XXXXX-XX",ext:"pdf",info:"Permit documents filed by agency permit number \u2014 ERP, NPDES, Section 404, Biological Opinions, and dewatering permits.",exampleName:"50-12345-P_Permit-SFWMD-ERP.pdf",title:false,designId:false,fpidFull:false,projectId:false,fpidShort:false,componentId:false,submittalSuffix:false,customId:true,formattedDate:false}
];
const ABBREVIATIONS={"Alignment":"Algn","Architectural":"Arch","Asbestos Containing Materials":"ACM","Attachment":"Atch","Calculation":"Calc","Calculations":"Calcs","Certificate":"Cert","Certification":"Cert","Cross Section":"Xsec","Cross-Section":"Xsec","Design":"Dsgn","Design Analysis Report":"DAR","Document":"Doc","Documents":"Docs","Drainage":"Drng","Drawing":"Dwg","Drawings":"Dwgs","Elevation":"Elev","Environmental":"Env","Evaluation":"Eval","Existing":"Exist","Geotechnical":"Geotech","Hydraulic":"Hydr","Information":"Info","Inspection":"Insp","Intelligent Transportation System":"ITS","Investigation":"Invstg","Justification":"Just","Landscape":"Lndscpe","Lighting":"Ltg","Maintenance":"Maint","Maximum":"Max","Memorandum":"Memo","Minimum":"Min","Modification":"Mod","Operations":"Ops","Original":"Orig","Package":"Pkg","Pavement":"Pvmt","Phase":"Ph","Preliminary":"Prelim","Profile":"Prof","Quantities":"Qtys","Quantity":"Qty","Report":"Rpt","Requirement":"Req","Requirements":"Reqs","Revision":"Rev","Right-of-Way":"ROW","Roadway":"Rdwy","Schedule":"Sched","Segment":"Seg","Shoulder":"Shldr","Signalization":"Sgnlztn","Standard":"Std","Structure":"Struct","Structures":"Structs","Survey":"Srvy","Temporary":"Temp","Typical":"Typ","Verification":"Vrfctn","Worksheet":"Wksht"};
const PROJECTS=[{name:"Project 1",abbr:"P1"},{name:"Project 2",abbr:"P2"},{name:"Project 3",abbr:"P3"},{name:"Project 4",abbr:"P4"},{name:"Project 5",abbr:"P5"},{name:"Accel Start Seg A",abbr:"PA"},{name:"Accel Start Seg B",abbr:"PB"}];
const FPIDS=[{fpid:"201210-8",desc:"I-4 from east of U.S. 27 to west of S.R. 429",full:"20121085201",project:"Accel Start Seg A"},{fpid:"431456-6",desc:"I-4 from west of S.R. 429 to east of World Drive",full:"43145665201",project:"Accel Start Seg B"},{fpid:"431456-7",desc:"I-4 from east of World Drive to east of U.S. 192",full:"43145675201",project:"Project 1"},{fpid:"445883-1",desc:"Southern Connector (SR 417) AET (M&R)",full:"44588315201",project:"Project 1"},{fpid:"445883-2",desc:"Southern Connector (SR 417) AET (Reconstruction)",full:"44588325201",project:"Project 1"},{fpid:"431456-3",desc:"I-4 from east of C.R. 532 to west of World Drive",full:"43145635201",project:"Project 2"},{fpid:"446581-6",desc:"Poinciana Connector, Greenfield - Ramps to EB I-4",full:"44658165201",project:"Project 2"},{fpid:"446581-3",desc:"Poinciana Connector, Modify/Construct I-4 Ramps with SR 429",full:"44658135201",project:"Project 2"},{fpid:"201210-9",desc:"I-4 from west of U.S. 27 to west of C.R. 532",full:"20121095201",project:"Project 3"},{fpid:"451381-2",desc:"Grandview Pkwy from north of Posner Blvd to Dunson Rd",full:"45138125201",project:"Project 3"},{fpid:"431456-2",desc:"I-4 from east of U.S. 192 to east of S.R. 536",full:"43145625201",project:"Project 4"},{fpid:"453159-3",desc:"I-4 EB Tube from west of S.R. 536 to west of Universal Blvd",full:"45315935201",project:"Project 4"},{fpid:"446581-4",desc:"Poinciana Connector (S.R. 538)",full:"44658145201",project:"Project 5"}];
